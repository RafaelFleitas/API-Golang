...
| `GET` | `/getUserById/:userId` | Busca usuário por ID | Em desenvolvimento |
| `GET` | `/getUserByEmail/:userEmail` | Busca usuário por e-mail | Em desenvolvimento |
| `PUT` | `/updateUser/:userId` | Atualiza usuário | Em desenvolvimento |
